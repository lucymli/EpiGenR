...
simulate_sir <- function(Rparams, dt, max_num_dt, min_epi_size, maximum_attempts, track_transmissions) {
    .Call('EpiGenR_simulate_sir', PACKAGE = 'EpiGenR', Rparams, dt, max_num_dt, min_epi_size, maximum_attempts, track_transmissions)
}
...
get_transmission_tree <- function(Repidemic) {
    .Call('EpiGenR_get_transmission_tree', PACKAGE = 'EpiGenR', Repidemic)
}
