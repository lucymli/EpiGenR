...
param_list <- create_params_list(
  ...
  prior_params=list(c(0.0, 0.01), c(1.0, 10000.0), c(1.0, 30.0), c(1.0, 3.0)), # Parameters for the prior distribution
  proposal_params=list(c(5e-5, 0.0, 0.01), c(0.1, 0.001, 10), c(1.0, 1.0, 30.0), c(0.05, 0.0, 1.0)),  
